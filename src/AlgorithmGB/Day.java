...
public class Day {
    ...
    public ArrayList<Integer> getTechUnavailable() { return techUnavailable; }
    public ArrayList<Integer> getTechAvailable() { return techAvailable; }
    public Team getTeams(int team) { return teams.get(team); }
